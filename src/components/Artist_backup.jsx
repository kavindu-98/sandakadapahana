      ...
      <div className="relative z-10 container mx-auto px-4 py-8 lg:py-16">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-7xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <p className="text-amber-900 leading-relaxed text-lg">
                Sankani Edirisinghe is the daughter of the celebrated Sri Lankan
                classical singer Sunil Edirisinghe and Nandani “Kumudu”
                Munasinghe. She has grown up immersed in music, and is
                recognized for her vocal talent, appearing in musical
